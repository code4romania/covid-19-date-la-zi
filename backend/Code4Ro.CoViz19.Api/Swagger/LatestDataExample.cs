...
namespace Code4Ro.CoViz19.Api.Swagger
{
    public class LatestDataExample : IExamplesProvider<ParsedDataModel>
    {
        private ParsedDataModel _fakeData ;
        ParsedDataModel IExamplesProvider<ParsedDataModel>.GetExamples()
        {
            if (_fakeData == null)
            {
