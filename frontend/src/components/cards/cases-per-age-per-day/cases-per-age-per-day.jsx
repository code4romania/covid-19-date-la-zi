...
export const EMBED_PATH_CASES_PER_AGE_PER_DAY = 'cazuri-pe-varsta-pe-zi';
export class CasesPerAgePerDayCard extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Card
        isLoaded={isLoaded}
        title="Cazuri după vârstă, pe zile"
        subtitle={`De la ${from} pana la ${to}`}
        isStale={isStale}
        error={error}
        embedPath={EMBED_PATH_CASES_PER_AGE_PER_DAY}
      >
        <ReactEcharts
          style={{
            height: '470px',
