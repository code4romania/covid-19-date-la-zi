...
export default () => {
  ...
  const footer = (
    <footer className="charts-footer">
      <div>
        ...
        <Image src="/images/partener.png" alt="Guvernul Romaniei" />
      </div>
      <div>
        <p>dezvoltat de</p>
        <Image src="/images/code4romania.svg" alt="Code4Romania" />
      </div>
    </footer>
  );
  ...
  const header = (
    <header>
      <Image src="/images/cetrebuiesafac.svg" alt="Ce Trebuie Sa Fac" />
      {size !== "ultraWide" && (
